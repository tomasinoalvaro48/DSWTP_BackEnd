...
describe('API Integration Tests', () => {
  ...
  describe('Tipo Anomalia Endpoints (GET y POST)', () => {
    ...
    test('GET /api/tipo_anomalia/:id - debería devolver 400 por formato de nombre inválido', async () => {
    ...
    test('POST /api/tipo_anomalia - debería crear y devolver un nuevo tipo_anomalia, si no está duplicado', async () => {
      const newTipo = {
