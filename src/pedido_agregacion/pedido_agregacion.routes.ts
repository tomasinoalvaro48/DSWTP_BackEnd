...
pedidos_agregacion_router.post('/', verifyToken, authorizeRoles(['cazador', 'operador']), upload.array('archivos', 10), generarPedidosAgregacion)
pedidos_agregacion_router.patch('/tomar-pedidos-agregacion/:id', verifyToken, authorizeRoles(['cazador', 'operador']), tomarPedidosAgregacion)
