  ...
  try {
    ...
    if (!valid) {
      ...
      pedido_resolucion.cazador.nivel_cazador =
        pedido_resolucion.cazador.nivel_cazador + pedido_resolucion.dificultad_pedido_resolucion
...
export { findAll, remove, generarPedidoResolucion, showMisPedidos, tomarPedidoResolucion, finalizarPedido }
