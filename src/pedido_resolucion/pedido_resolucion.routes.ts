...
import { generarPedidosResolucion, findAll, remove, calcularDificultad } from './pedido_resolucion.controller.js'

export const pedidos_resolucion_router = Router()

pedidos_resolucion_router.post('/',generarPedidosResolucion)
