...
usuarioRouter.patch('/approve/:id', verifyToken, authorizeRoles(['operador']), sanitizeUsuarioImput, approveCazador)
usuarioRouter.patch('/reject/:id', verifyToken, authorizeRoles(['operador']), sanitizeUsuarioImput, rejectCazador)
